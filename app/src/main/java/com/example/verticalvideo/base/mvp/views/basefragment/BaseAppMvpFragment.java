package com.example.verticalvideo.base.mvp.views.basefragment;
...
public abstract class BaseAppMvpFragment<P extends BaseMvpPresenter> extends MvpFragment<P> implements IBaseMvpView {
}
